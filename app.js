$(document).ready(function () {
	...
	if (!isChrome) {
		document.body.innerHTML = "<p style=\"position:fixed;bottom:0;width:100%;text-align:center;font-size:18px;color:rgb(160, 242, 207)\">Sorry! For now, Music Visualizer only works with Google Chrome.</p>";
	}
